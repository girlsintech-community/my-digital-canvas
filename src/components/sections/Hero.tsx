...
import { Youtube, Instagram, Github, Linkedin, Twitter, Send, Calendar } from "lucide-react";
    ...
    <section className="pt-24 sm:pt-28 pb-12 sm:pb-16 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 mb-8">
          <div className="w-full sm:w-auto sm:flex-1 flex flex-col items-center sm:items-start text-center sm:text-left order-1 sm:order-2">
            ...
            <p className="font-sans text-sm sm:text-base text-muted-foreground whitespace-nowrap flex items-center justify-center sm:justify-start">
              ...
              <span className="bg-gradient-to-r from-red-500 to-purple-500 bg-clip-text text-transparent font-medium">{typedRole}</span>
