              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-3 py-2 pr-10 text-sm rounded-lg bg-background border border-border text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                  />
                  <button
                    type="button"
